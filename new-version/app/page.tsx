...
import { Button, Card, Description, FieldError, Fieldset, FieldsetLegend, Input, Label, Spinner, Switch, TextField } from "@heroui/react";
...
export default function Home() {
  ...
  const [guardianList, setGuardianList] = useState<Array<{ id: string; name: string; email: string; phone: string; relation: string; isPrimary: boolean }>>([{ id: "g-0", name: "", email: "", phone: "", relation: "", isPrimary: true }]);
  ...
  function handleAddGuardian() {
    setGuardianList((prev) => [...prev, { id: generateId(), name: "", email: "", phone: "", relation: "", isPrimary: false }]);
  }
            ...
            >
              <Card className="min-w-[26vw] border border-divider/70 bg-content1/80 p-8 shadow-xl shadow-black/10 backdrop-blur-md">
                ...
                <p className="mt-4 text-sm text-muted">
                  Chưa có tài khoản?{" "}
                  <button
                    className="text-primary text-blue-600 hover:underline"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-8">
                          ...
                          <div key={guardian.id} className="space-y-4 border border-divider p-5 rounded-2xl">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex gap-4 items-center">
                                ...
                                <select
                                  className="bg-background border border-divider rounded-lg px-3 py-2 text-foreground"
                                  name="relation"
                                  id="relation"
                                  value={guardian.relation}
                                  onChange={(e) => handleGuardianFieldChange(guardian.id, "relation", e.target.value)}
                                >
                                  <option>Ba</option>
                                  <option>Mẹ</option>
                                </select>
                ...
                <Card className="border border-divider/70 bg-content1/80 p-8 shadow-xl shadow-black/10 backdrop-blur-md">
                  ...
                  <button
                    className="mt-8 w-full text-primary text-blue-600 hover:underline text-center py-2"
